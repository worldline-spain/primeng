define(["require", "exports", "@angular/core", "@angular/animations", "@angular/common", "../dom/domhandler", "../button/button", "@angular/router", "@angular/router"], function (require, exports, core_1, animations_1, common_1, domhandler_1, button_1, router_1, router_2) {
    "use strict";
