 ...
 */
/* tslint:disable */
define(["require", "exports", "@angular/core", "./steps", "@angular/common", "@angular/router"], function (require, exports, i0, i1, i2, i3) {
    "use strict";
    ...
    function View_Steps_2(_l) {
        return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, null, null, 7, 'a', [['class',
                    'ui-menuitem-link']], [[8, 'href', 4], [1, 'target', 0], [1, 'id', 0]], [[null,
            ...
            var currVal_3 = (_v.parent.context.index + 1);
    ...
    function View_Steps_3(_l) {
        return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, null, null, 12, 'a', [['class',
                    'ui-menuitem-link']], [[1, 'target', 0], [1, 'id', 0], [1, 'target', 0], [8, 'href', 4]], [[null, 'click']], function (_v, en, $event) {
                var ad = true;
                var _co = _v.component;
                if (('click' === en)) {
                ...
                return ad;
            }, null, null)), i0.ɵdid(671744, [[2, 4]], 0, i3.RouterLinkWithHref, [i3.Router, i3.ActivatedRoute, i2.LocationStrategy], { queryParams: [0, 'queryParams'],
                routerLink: [1, 'routerLink'] }, null), i0.ɵdid(1720320, null, 2, i3.RouterLinkActive, [i3.Router, i0.ElementRef, i0.Renderer2, i0.ChangeDetectorRef], { routerLinkActiveOptions: [0, 'routerLinkActiveOptions'], routerLinkActive: [1, 'routerLinkActive'] }, null), i0.ɵqud(603979776, 1, { links: 1 }), i0.ɵqud(603979776, 2, { linksWithHrefs: 1 }),
            ...
            var currVal_8 = (_v.parent.context.index + 1);
