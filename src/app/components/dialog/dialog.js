define(["require", "exports", "@angular/core", "@angular/animations", "@angular/common", "../dom/domhandler", "../common/shared"], function (require, exports, core_1, animations_1, common_1, domhandler_1, shared_1) {
    "use strict";
    ...
    var Dialog = (function () {
        ...
        Dialog.prototype.focus = function () {
            var focusable = this.domHandler.findSingle(this.containerViewChild.nativeElement, 'button, input, textarea, select');
            if (focusable) {
                focusable.focus();
            }
        };
