...
function View_Dialog_2(_l) {
    return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, null, null, 1, 'span', [['class',
                'ui-dialog-title']], [[1, 'id', 0]], null, null, null, null)),
...
function View_Dialog_1(_l) {
    return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, [[2, 0], ['titlebar', 1]], null, 10, 'div', [['class', 'ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top']], null, [[null, 'mousedown'], [null, 'mouseup']], function (_v, en, $event) {
        ...
        var currVal_1 = (_co.headerFacet && _co.headerFacet.first);
...
function View_Dialog_0(_l) {
    return i0.ɵvid(0, [i0.ɵqud(402653184, 1, { containerViewChild: 0 }), i0.ɵqud(671088640, 2, { headerViewChild: 0 }), i0.ɵqud(402653184, 3, { contentViewChild: 0 }), (_l()(), i0.ɵted(null, ['\n        '])), (_l()(), i0.ɵeld(0, [[1, 0], ['container', 1]], null, 19, 'div', [['role', 'dialog']], [[4, 'display', null], [4, 'width', 'px'], [4, 'height',
                'px'], [4, 'minWidth', 'px'], [24, '@dialogState', 0], [1, 'aria-labelledby', 0]], [[null, 'mousedown']], function (_v, en, $event) {
            var ad = true;
            var _co = _v.component;
            if (('mousedown' === en)) {
        ...
        i0.ɵdid(16384, null, 0, i2.NgIf, [i0.ViewContainerRef, i0.TemplateRef], { ngIf: [0,
            ...
            i0.ɵted(null, ['\n    ']))], function (_ck, _v) {
        var _co = _v.component;
        var currVal_6 = _co.styleClass;
        var currVal_7 = _ck(_v, 6, 0, true, _co.rtl, _co.draggable);
        _ck(_v, 5, 0, currVal_6, currVal_7);
        var currVal_8 = _co.style;
        _ck(_v, 7, 0, currVal_8);
        var currVal_9 = _co.showHeader;
        _ck(_v, 10, 0, currVal_9);
        var currVal_10 = _co.contentStyle;
        _ck(_v, 13, 0, currVal_10);
        var currVal_11 = (_co.footerFacet && _co.footerFacet.first);
        _ck(_v, 19, 0, currVal_11);
        var currVal_12 = _co.resizable;
...
function View_Dialog_Host_0(_l) {
    return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, null, null, 4, 'p-dialog', [], null, null, null, View_Dialog_0, exports.RenderType_Dialog)),
        i0.ɵprd(512, null, i4.DomHandler, i4.DomHandler, []), i0.ɵdid(12763136, null, 2, i1.Dialog, [i0.ElementRef, i4.DomHandler, i0.Renderer2, i0.NgZone], null, null), i0.ɵqud(603979776, 1, { headerFacet: 1 }), i0.ɵqud(603979776, 2, { footerFacet: 1 })], null, null);
}
