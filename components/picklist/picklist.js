...
PickList.propDecorators = {
    ...
    'showSourceFilter': [{ type: core_1.Input },],
    'showTargetFilter': [{ type: core_1.Input },],
    ...
    'sourceFilterViewChild': [{ type: core_1.ViewChild, args: ['sourceFilter',] },],
    'targetFilterViewChild': [{ type: core_1.ViewChild, args: ['targetFilter',] },],
